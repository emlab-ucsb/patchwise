...
#'
#' @description This function creates a dataframe of targets for each of the
#'   features to be used in the prioritization
#'
#' @param targets a vector of targets for protection (range between 0 and 1);
#'   must be the same length as the number of features + the pre-patches
#'   variable
...
#' @param pre_patches a raster or sf object that includes the feature that is to
#'   be split into patches (not the layer that is already split into patches)
...
#'
#' @return A data frame to be used to specify targets for features. Will need to
#'   be plugged into `constraint_targets()` before being implemented into
#'   prioritizr
#' @export
#'
#' @examples
